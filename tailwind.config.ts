    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-eco": {
          ...
          "50%": { boxShadow: "0 0 0 8px hsl(var(--eco-green) / 0)" },
        },
        "pulse-tech": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--tech-blue) / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--tech-blue) / 0)" },
        },
        shimmer: {
      ...
      animation: {
        ...
        "pulse-tech": "pulse-tech 2s infinite",
